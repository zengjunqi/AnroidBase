...
public class MediaPlayerPlayNetworkMusic extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		etPath.setText("http://10.10.10.83:8080/2.mp3");
	...
	private void Play() {
		...
		if (path.startsWith("http://")) {
			...
			Toast.makeText(this, "网址有误", 1000).show();
		}
	}
